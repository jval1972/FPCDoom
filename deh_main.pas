    ...
    ////////////////////////////////////////////////////////////////////////////
      ...
      // Retrieve current think field index
        ...
        case mobj_idx of
          ...
          24: begin
                if mobj_val >= 0 then
                  mobjinfo[mobj_no].flags_ex := mobj_val  // lighting, transparency, etc
                else
                begin
                  mobj_setflag := -1;
                  repeat
          ...
          25: mobjinfo[mobj_no].customsound1 := S_GetSoundNumForName(token2);
          26: mobjinfo[mobj_no].customsound2 := S_GetSoundNumForName(token2);
          27: mobjinfo[mobj_no].customsound3 := S_GetSoundNumForName(token2);
          ...
          39: begin
                if mobj_val >= 0 then
                  mobjinfo[mobj_no].flags2_ex := mobj_val
                else
                begin
                  mobj_setflag := -1;
                  repeat
    ...
    ////////////////////////////////////////////////////////////////////////////
      ...
      begin
        ...
        case state_idx of
           ...
           7: begin
                if state_val >= 0 then
                  states[state_no].flags_ex := state_val  // lighting, transparency, etc
                else
                begin
                  state_setflag := -1;
                  repeat
...
begin
  ...
  mobj_tokens.Add('FLAGS_EX');           // .flags_ex                 // 24
