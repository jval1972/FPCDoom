...
begin
  ...
  fracrowstep := t.GetHeight * FRACUNIT div SCREENHEIGHT;
  fraccolstep := twidth * FRACUNIT div SCREENWIDTH;
...
var
  i: integer;
begin
  for i := 1 to numdrawtextures - 1 do
